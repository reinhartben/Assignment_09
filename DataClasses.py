...
# BReinhart, 2021-Mar-09, Added Track class constructor, properties, and methods
# BReinhart, 2021-Mar-09, Added code for CD class methods
#------------------------------------------#
...
class Track():
    ...
    def __str__(self):
        ...
        return 'Track {}: {} ({})'.format(self.__position, self.__title, self.__length)
